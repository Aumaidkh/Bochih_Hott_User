...
public class VerticalFoodItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
   ...
   // private TextView mFoodCategory;
    ...
    public VerticalFoodItemViewHolder(@NonNull View itemView, FoodItemListener listener) {
        super(itemView);
