...
public class OrderModel {
    ...
    private ArrayList<CartItem_> items;
    ...
    public OrderModel(String customer_id, String delivery_address, String estimated_delivery_time, float price, String order_time, String restaurant_id, String timestamp, ArrayList<CartItem_> items) {
    ...
    public ArrayList<CartItem_> getItems() {
        return items;
    }

    public void setItems(ArrayList<CartItem_> items) {
        this.items = items;
    }
