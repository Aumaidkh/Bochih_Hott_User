...
public class FinalNearByRestaurantsAdapter extends RecyclerView.Adapter<RestaurantsViewHolder> {
  ...
  //  private HomeFragment fragment;
    ...
    public FinalNearByRestaurantsAdapter(ArrayList<Partner> mPartners, Context mContext, RestaurantListener restaurantListener) {
    ...
    public RestaurantsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.sample_homefragment_nearby_restaurants,parent,false);
